...
$conn = mysqli_connect("localhost", "root", "", "bienestarmental") or die("Database Error");
...
$check_data = "SELECT replies FROM bm_psychologist WHERE queries LIKE '%$getMesg%'";
...
if (mysqli_num_rows($run_query) > 0) {
    ...
    echo "¡Lo siento, no puedo ayudarte con este inconveniente! Favor intenta nuevamente";
}
